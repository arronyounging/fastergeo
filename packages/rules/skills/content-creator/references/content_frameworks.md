...
- [ ] Title under 60 characters (enforced by SEO linter)
- [ ] Meta description written, max 160 chars (enforced by SEO linter)
- [ ] Headers properly structured — one H1, no skipped levels (enforced by SEO linter)
- [ ] Internal links added (2-3), no broken links (enforced by SEO linter)
- [ ] Images optimized with alt text
- [ ] Featured image with descriptive alt text
- [ ] CTA included and clear
- [ ] Proofread and fact-checked
- [ ] Mobile preview checked
- [ ] Project-specific SEO/content linter passes (if available)
