...
const ISSUE_TICKETS: Record<TicketLang, Record<string, IssueSpec>> = {
  en: {
    ...
    'thin-text': { title: 'Add substantive visible text to near-empty pages', priority: 'P1', desc: 'pages under 120 word-equivalents drop to 0', toZero: true },
  ...
  zh: {
    ...
    'thin-text': { title: '给近空页面补充实质可见正文', priority: 'P1', desc: '低于 120 词等效的页面数降为 0', toZero: true },
